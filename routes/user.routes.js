...
router.put("/edit", [authJwt.verifyToken, verifySignUp.checkUpdatePassword, verifySignUp.checkBirthday, verifySignUp.checkEmail, verifySignUp.checkUpdateEmail], user.edit);
